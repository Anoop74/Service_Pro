...
.button2 {border-radius: 4px; background-color: #f44336;}
</style>
</head>
<body>
<header>
...
<h3 class="mb-lg-4 mb-md-3 mb-sm-2 mb-2">REQUESTS</h3>
<div class="container">
<div class="limiter">
		<div class="container-table100">
			<div class="wrap-table100">
				...
				<?php
					require_once "db.php";
					$t_id=$_SESSION['t_id']; 
					$result = mysqli_query($conn,"SELECT * FROM req_tbl where t_id=$t_id and status=0");
					?>
					<?php
					...
					<table>
						<thead>
							<tr class="table100-head">
								...
								<th class="column6">Accept/Reject</th>
							</tr>
						</thead>
						<?php
							$i=0;
						...
						<tbody>
								<tr>
									...
									<td class="column3"><?php echo $row["addr"]; ?></td>
									<td class="column4"><?php echo $row["job"]; ?></td>
									<td class="column5"><?php echo $row["date"]; ?></td>
									<td class="column6"><a href="accp.php?id=<?php echo $row['rid'];?>"><button class="button">Accept</button></a> 
								    <a id="rej" href="del.php?id=<?php echo $row['rid'];?>"><button class="button button2">Reject</button></a></td>
								</tr>
								<?php
								$i++;
								$n++;
