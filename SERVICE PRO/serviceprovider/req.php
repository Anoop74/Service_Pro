...
<div class="section">
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: rgba(10, 5, 5, 0.650);">
    ...
    <span class="navbar-toggler-icon"></span>
      ...
      <li class="nav-item ">
        <a class="nav-link" href="servhome.php">Home</a>
      </li>
      <li class="nav-item ">
      <a class="nav-link" href="req.php">Request list</a>
      </li>
      <li class="nav-item ">
      <a class="nav-link" href="servicestatus.php">Services status</a>
      </li>
...
$l=$_SESSION['gid'];
$a="select * from tech_login where t_name='$l'";
...
$v="select * from req_tbl where status='0' and job='$z'";
...
<td><a href="acceptreq.php?reqid=<?php echo $g['reqid'];?>"class="btn btn-danger">ACCEPT</a></td>
