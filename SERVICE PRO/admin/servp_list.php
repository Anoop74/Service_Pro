    ...
    <span class="navbar-toggler-icon"></span>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="#">Service Provider list</a>
...
<li class="w3">
	...
	<div class="container py-4 mt-2">
				<h3 class="hdg mt-5">SERVICE PROVIDER LIST</h3>
				<form method="post">

<div class="text-center"><input type="submit" name="approve" value="APPROVED" class="btn" style="background-color: #28a745;">&nbsp;&nbsp;&nbsp;<input type="submit" name="reject" value="REJECTED" class="btn" style="background-color: #dc3545;"><br /></div>
...
$v="SELECT * from `tech_login` where status='approve'";
...
<td><a href="servp_rejected.php?id=<?php echo $g['t_id'];?>" class="btn btn-danger">REJECT</a></td>
</tr>
<?php
$i=$i+1;
}
...
$i=1;
$con=mysqli_connect("localhost","root","","houseservice");
$v="SELECT * from `tech_login` where status='reject'";
$f=mysqli_query($con,$v);
if(mysqli_num_rows($f)>0)
{?>
...
<td><a href="servp_approved.php?id=<?php echo $g['t_id'];?>"  class="btn btn-success">APPROVE</a></td>
