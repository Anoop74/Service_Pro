...
?>
	...
	if(isset($_POST['submit']))
	{
		...
		$d="INSERT INTO `services`(`id`, `service`,`charge`,`image`, `description`) VALUES  ('','$serv','$char','$img','$des')";
		mysqli_query($con,$d);
		?>
    ...
    if(isset($_GET['edit']))
	{
		...
		$d="DELETE FROM `services` WHERE id=$id";
		mysqli_query($con,$d);
	?>
	<script type="text/javascript">
...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: rgba(10, 5, 5, 0.650);">
    ...
    <span class="navbar-toggler-icon"></span>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="customer_requests.php">Customer requests</a>
...
<li class="w3">
	...
	<div class="container py-4 mt-2">
				<h3 class="hdg mt-5">ADD SERVICES</h3>
				...
				<div class=" contact-form">
				   <form action="addservice.php" method="post" enctype="multipart/form-data">
					  <div class="row contact-bothside-agileinfo">
                         ...
                         <input type="text" name="serv" id="service" required="required" placeholder="Service"><br>
						 <input type="text" name="charge" id="charge" required="required" placeholder="Fixed charge"><br>
                         <input type="file" name="image"/><br>
                         <textarea  rows="5" name="des"  placeholder="Description"></textarea>
						 </div>
						 </div>
...
<td><img src="../images/<?php echo $f['image'];?>" height="50px" width="50px"/></td>
<td><?php echo $f['charge'];?></td>
<td><a href="addservice.php?edit=<?php echo $f['id'];?>" class="btn btn-danger">DELETE</a></td>
</tr>
<?php
}
?>
